...
const AISearchBar = ({ extended, mobileOpen }) => {
  ...
  return (
    <div style={style} className="fixed bottom-0 z-40 flex justify-center pb-4 pt-2 px-4 border-t border-gray-700 bg-transparent">
      <div className="flex items-center w-full max-w-2xl bg-gray-800 rounded-2xl shadow-md border border-gray-700 px-4 py-2 gap-3">
        ...
        />
        <button className="text-gray-400 hover:text-indigo-400 transition" aria-label="Voice">
          <IoMicOutline className="w-5 h-5" />
        </button>
        <button className="text-gray-400 hover:text-indigo-400 transition" aria-label="Send">
